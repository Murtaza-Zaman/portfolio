    ...
    <div className="w-full space-y-1.5">
      ...
      <select
        ...
        className={cn(
          ...
          dark
            ? "border border-white/10 bg-[#071022] text-white focus:border-cyan-400 focus:ring-cyan-500/20 disabled:bg-white/[0.02]"
            : "border border-slate-300 bg-white text-slate-900 focus:border-teal-600 focus:ring-teal-600/20 disabled:bg-slate-50",
      ...
      >
        {options
          ? options.map((opt) => (
              <option className="bg-[#050c1a] text-white" key={opt.value} value={opt.value}>
                {opt.label}
              </option>
            ))
          : children}
